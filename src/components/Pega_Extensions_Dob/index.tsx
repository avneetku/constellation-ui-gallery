...
import StyledPegaExtensionsDobWrapper from './styles';

// interface for props
interface PegaExtensionsDobProps extends PConnFieldProps {
...
function PegaExtensionsDob(props: PegaExtensionsDobProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledPegaExtensionsDobWrapper> {displayComp} </StyledPegaExtensionsDobWrapper>
    ) : (
      <StyledPegaExtensionsDobWrapper>
        <FieldValueList
...
export default withConfiguration(PegaExtensionsDob);
